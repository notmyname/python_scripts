...
careq = createCertRequest(cakey, digest="sha512", CN='Certificate Authority')
cacert = createCertificate(careq, (careq, cakey), 0, (0, 60*60*24*365*5), digest="sha512") # five years
...
for (fname, cname) in [('client', 'john'), ('server', 'Simple Server')]:
    pkey = createKeyPair(TYPE_RSA, 1024)
    req = createCertRequest(pkey, CN=cname)
    cert = createCertificate(req, (cacert, cakey), 1, (0, 60*60*24*365*5), digest="sha512") # five years
